...
const Update_profile = () => {
    ...
    return (
        <div className=" bg-gradient-to-r from-green-200 to-green-400 p-5 ">
            <div className=" ">
                ...
                <div className="md:flex  gap-5 grid grid-cols-1">
                    {/* showing profile */}
                    <div className=" w-full p-8 sm:flex sm:space-x-6 md:bg-white justify-center dark:text-gray-800">
                        <div className="flex flex-col">
                            <div className=" mx-auto">
                                <img src={user.photoURL} alt="" className="md:w-[200px] md:h-[200px] rounded-full md:rounded-none " />
                            </div>
